...
if (isset($_REQUEST['submit']))
{
    ...
    query("INSERT INTO `partners`(`email`, `password`, `wallet`, `ledger`, `comission`, `partnership`, `active`) VALUES ('$email','$password','0','0','$comission','$partnership','1')");
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="Comission" name="comission" required>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="Partnership">Partnership</label>
                                        <input type="number" class="form-control" id="Partnership" name="partnership" required>
                                    </div>
