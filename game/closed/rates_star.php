...
query("UPDATE `rates_star` SET `single`='$single',`singlepatti`='$spatti',`doublepatti`='$dpatti',`triplepatti`='$tpatti' WHERE sn='1'");
}

$sc = query("select * from rates_star where sn='1'");
$s = fetch($sc);
