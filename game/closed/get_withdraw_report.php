...
$blog = query("select * from transactions where remark like '%Withdraw to %' AND type='0' AND created_at > $start_time AND created_at < $end_time");
             ...
             <div class="card">
                ...
                <div class="card">
                    <div class="card-body">
                                 ...
                                 <h4 class="card-title" style="margin-top:20px;">Withdraw history</h4>
                                    ...
                                    <table id="order-listing" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo str_replace("Withdraw to","",$bl['remark']) ?></td>
