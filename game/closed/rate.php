...
query("UPDATE `rate` SET `single`='$single',`jodi`='$jodi',`singlepatti`='$spatti',`doublepatti`='$dpatti',`triplepatti`='$tpatti',`halfsangam`='$half',`fullsangam`='$full' WHERE sn='1'");
}
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Rates</h4>
                                ...
                                <form class="forms-sample" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="number" class="form-control" value="<?php echo $s['halfsangam']; ?>"  id="exampleInputName1" name="half">
                                    </div>
                                    
                                    <div class="form-group">
                                      <label for="exampleInputName1">Full Sangam</label>
                                        <input type="number" class="form-control" value="<?php echo $s['fullsangam']; ?>"  id="exampleInputName1" name="full">
                                    </div>
