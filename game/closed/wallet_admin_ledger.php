...
if(isset($_REQUEST['submit']))
{
    ...
    if($type=="0"){
        query("update partners set ledger=ledger-'$amount' where sn='$user'");
    } else {
        query("update partners set ledger=ledger+'$amount' where sn='$user'");
    }
    
    query("INSERT INTO `transactions`(`user`, `amount`, `type`, `remark`, `created_at`,`owner`) VALUES ('admin','$amount','$type','$remark','$stamp','$user')");
    
}

$blog = query("select * from transactions where owner='$user' AND user='admin'");

$us = query("select ledger from partners where sn='$user'");
$u = fetch($us);
    ...
    <?php include "include/header.php"; ?>
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Manage Partner Ledger ( Ledger Balance :  <b><?php echo $u['ledger']; ?></b> )</h4>
