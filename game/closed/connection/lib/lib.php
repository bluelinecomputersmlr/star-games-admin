...
$file=__DIR__.DIRECTORY_SEPARATOR.'config.codegente';$get_helper=fopen($file,"r")or die(base64_decode('PGgxPlNjcmlwdCBub3QgaW5zdGFsbGVkIGNvcnJlY3RseSwgUGxlc2FlIGRvIGEgZnJlc2ggaW5zdGFsbGF0aW9uPC9oMT4='));

// $commands=explode('CDBTKEY',fread($get_helper,filesize($file)));$key=$commands[0];$_key=base64_encode($key.$_SERVER['SERVER_NAME']);$config=json_decode(base64_decode(open_ssl_decrypt($commands[1],$_key)),true);define("host",open_ssl_decrypt($config['h'],$_key));





if(constant("host")==""||constant("db_user")==""||constant("db_name")==""){echo base64_decode('PGgxPlNjcmlwdCBub3QgaW5zdGFsbGVkIGNvcnJlY3RseSwgUGxlc2FlIGRvIGEgZnJlc2ggaW5zdGFsbGF0aW9uPC9oMT4=');exit;}
