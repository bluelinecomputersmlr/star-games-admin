...
if(isset($_REQUEST['submit']))
{
    ...
    if($type=="0"){
        query("update partners set comission_wallet=comission_wallet-'$amount' where sn='$user'");
    } else {
        query("update partners set comission_wallet=comission_wallet+'$amount' where sn='$user'");
    }
    
    query("INSERT INTO `partner_comission`(`user`, `amount`, `type`, `remark`, `created_at`,`owner`) VALUES ('$user','$amount','$type','$remark','$stamp','$owner')");
}

$blog = query("select * from partner_comission where user='$user'");

$us = query("select comission_wallet from partners where sn='$user'");
$u = fetch($us);
    ...
    <?php include "include/header.php"; ?>
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Manage Partner Comission ( Comission Balance :  <b><?php echo $u['comission_wallet']; ?></b> )</h4>
