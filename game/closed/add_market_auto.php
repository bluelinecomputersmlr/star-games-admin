...
if (isset($_REQUEST['submit']))
{
    ...
    if(rows(query("select sn from gametime_auto where market='$market'")) == 0){
        ...
        query("INSERT INTO `gametime_auto`(`market`, `open`, `close`, `days`,`sort_no`) VALUES ('$market','$open','$close','$dd','1')");
        
        redirect("market_list_auto.php");
