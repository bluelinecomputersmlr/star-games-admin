...
if($game == "single"){
    ...
    $getTotal = query("select * from games where bazar='$market' AND ( game='singlepatti' OR game='doublepatti' OR game='tripepatti' ) AND date='$date'");
...
<div class="row">
    ...
    if($game == "single"){
        ...
        $getBets = query("select * from games where bazar='$market' AND ( game='singlepatti' OR game='doublepatti' OR game='tripepatti' ) AND number='$number' AND date='$date'");
    ...
    $num_bets2 += rows(query("select sn from games where bazar='$market' AND game='single' AND number='$single_num' AND date='$date'"));
