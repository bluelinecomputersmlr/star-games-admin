            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Select Winning Number ( These are only number that user bets )</h4>

                                <form class="forms-sample" method="get" action="verify.php">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-sm-12">
                                                ...
                                                <select required class="form-control custom-select my-2" name="number">
                                                    <option value="">Select state</option>
                                                     <?php while ($bl = fetch($blog)) { ?>
                                                        <option><?php if($game=="jodi"){ echo sprintf("%02d", $bl['number']); } else {  echo $bl['number']; } ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
