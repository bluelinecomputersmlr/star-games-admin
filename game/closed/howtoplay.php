...
query("update content set howtoplay='$notice'");
}

$xc = query("select howtoplay from content where sn='1'");
$x = fetch($xc);
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" enctype="multipart/form-data">
                                   ...
                                   <div class="yui3-cssreset">
                                    ...
                                    <textarea name="notice" id="editor" ><?php echo $x['howtoplay']; ?></textarea>
