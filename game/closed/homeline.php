...
query("update content set homeline='$opass'");
}

$xc = query("select homeline from content where sn='1'");
$x = fetch($xc);
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Homescreen heading</h4>

                                <form class="forms-sample" method="post" enctype="multipart/form-data">
                                   
                                   <div class="yui3-cssreset">
                                       
                                    <textarea name="opass" id="editor" ><?php echo $x['homeline']; ?></textarea>
                                   </div>
