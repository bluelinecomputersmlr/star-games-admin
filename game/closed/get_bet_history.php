...
$blog = query("select * from games where created_at > $start_time AND created_at < $end_time");
$blog2 = query("select * from starline_games where created_at > $start_time AND created_at < $end_time");
             ...
             <div class="card">
                ...
                <div class="card">
                    <div class="card-body">
                                 ...
                                 <h4 class="card-title" style="margin-top:20px;">Bet history</h4>
