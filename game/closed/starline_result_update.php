                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="analysis_report_single.php?game=single&market=<?php echo $mrk['name']; ?>&timing=<?php echo $xc['close']; ?>"> <button class="btn btn-primary" >Single</button> </a>
                                
                                <a href="analysis_report_single.php?game=panna&market=<?php echo $mrk['name']; ?>&timing=<?php echo $xc['close']; ?>"> <button class="btn btn-primary" >Panna</button> </a>
                                
                                
                                <form class="forms-sample" method="post" enctype="multipart/form-data" style="margin-top:20px">
