...
if (isset($_REQUEST['submit']))
{
    ...
    if(rows(query("select sn from gametime_new where market='$market'")) == 0){
        ...
        query("INSERT INTO `gametime_new`(`market`, `open`, `close`, `days`) VALUES ('$market','$open','$close','$dd')");
        
        redirect("market_list.php");
