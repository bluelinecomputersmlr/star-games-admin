...
if (isset($_REQUEST['submit']))
{
    ...
    sendNotiicaton($body,$title,$topic);
    
    $success = "Notification sent successfully";
}

$sc = query("select name,mobile from users order by name");
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" style="    margin-bottom: 10px !important">
                                        <label for="exampleFormControlSelect1">Select Target Users</label>
                                        <select class="form-control form-control-lg" name="topic" id="exampleFormControlSelect1">
                                            <option value='all'>All Users</option>
                                          <?php  while($s = fetch($sc)) { ?>
                                            <option value='<?php  echo $s['mobile']; ?>'><?php echo $s['name'].' ('.$s['mobile'].')'; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputName1" name="body">
                                    </div>
