                                    ...
                                    <table id="example" class="table">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($bl['status']==0) { ?>
                                                        <a href="deposit_requests.php?complete=<?php echo $bl['sn']; ?>"> <button class="btn btn-outline-success">Mark as complete</button> </a>
                                                        <a href="deposit_requests.php?cancel=<?php echo $bl['sn']; ?>"> <button class="btn btn-outline-success">Cancel</button> </a>
                                                    <?php } else { ?>
                                                        No action available
                                                    <?php } ?>
                                                </td>
